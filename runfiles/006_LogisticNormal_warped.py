...
run_flags=['--savedir=%s'%savedir,
           ...
           '-lr 5e-4',
           '-ds 50',
           '-model LogisticNormal_warped',
           #'--learn_posterior=True',
           '--track_params=False',
           '-seed 1',
           '-rv 0.1']
vary_flags = {
    'warp_shp2e0_cw128':'--sharpening=2 -cw 128 --posterior_c=-6 --annealSharpening=50000',
    'warp_shp3e0_cw128':'--sharpening=3 -cw 128 --posterior_c=-6 --annealSharpening=50000',
    'warp_shp5e0_cw128':'--sharpening=5 -cw 128 --posterior_c=-6 --annealSharpening=50000',
}
