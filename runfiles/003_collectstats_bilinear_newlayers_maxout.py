...
exptdir = '003_collectstats_bilinear2_newlayers_maxout'
script = 'train.py'
...
vary_vals = {
        ...
        'hzl2-mBN':'-hzl 2 -zl 1 -pzl 1 --batchnorm=True --separateBNrunningstats=True --modifiedBatchNorm=True',
        'pzl2-mBN':'-hzl 1 -zl 2 -pzl 2 --batchnorm=True --separateBNrunningstats=True --modifiedBatchNorm=True',
