...
exptdir = '004_LogGammaLatentMixture'
script = 'train.py'
...
var_flags = {
        'static':'',
        'learn_prior':'--learn_prior=True',
        'learn_prior_and_posterior':'--learn_prior=True --learn_posterior=True',
        }
