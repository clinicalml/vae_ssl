...
vary_flag = '{val}'
vary_vals = {
#'maxout2_nKL_BN':'--logpxy_discrete=True --negKL=True --batchnorm=True --separateBNrunningstats=True',
'maxout2_nKL_BN_sh3':'--logpxy_discrete=True --negKL=True --batchnorm=True --separateBNrunningstats=True --sharpening=3',
}
start_gpu = 2
ignore = []
