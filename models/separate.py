...
class LogGammaSemiVAESeparate(LogGammaSemiVAE, object):
    def __init__(self, params, paramFile=None, reloadFile=None):
        self._tVariables = {}
        self._BNprefix = None
        super(LogGammaSemiVAESeparate,self).__init__(params, paramFile=paramFile, reloadFile=reloadFile)
    ...
    def _build_qz(self,hx,evaluation,modifiedBatchNorm,graphprefix):
        ...
        suffix = '_e' if evaluation else '_t'
        #merge h(x) and alpha
        q_Z_hidden = self._buildHiddenLayers(hz,self.params['z_inference_layers'],'q_Z_{layer}',evaluation,modifiedBatchNorm=modifiedBatchNorm)
    ...
    def _buildGraph(self, X, eps, betaprior=0.2, Y=None, dropout_prob=0.,add_noise=False,annealKL=None,evaluation=False,modifiedBatchNorm=False,graphprefix=None):
        ...
        #    alpha = T.nnet.softmax(U)
        # q(z|x,alpha)
        mu, logcov = self._build_qz(hx,evaluation,modifiedBatchNorm,graphprefix) 
